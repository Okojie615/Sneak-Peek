...
const savedSearch = document.getElementById("user-search"); 
...
// var savedSearch = document.getElementById("user-search");
// savedSearch.value = userSearch.value;
// savedSearch.elements[1].value = userSearch.elements[1].value;
// savedSearch.elements[2].value = userSearch.elements[2].value;
